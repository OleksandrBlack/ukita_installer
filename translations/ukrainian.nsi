...
;MHDDOSSETTINGS
LangString mhddos_settings ${LANG_UKRAINIAN} "Налаштування"
LangString mhddos_text_lng ${LANG_UKRAINIAN} "Змінити мову"
LangString mhddos_lang ${LANG_UKRAINIAN} "ua"
LangString mhddos_copies ${LANG_UKRAINIAN} "Запуск декількох копій (auto для максимального значення, потрібно 3+ ядер процесору та стабільний інтернет)"
LangString mhddos_vpn ${LANG_UKRAINIAN} "Додати свій IP/VPN до атаки (при використанні VPN чи виділеного сервера)"
LangString mhddos_percents ${LANG_UKRAINIAN} "Укажіть частку використання IP адреси, якщо vpn=true (за замовчуванням 2%)"
LangString mhddos_threads ${LANG_UKRAINIAN} "Кількість потоків на 1 копію (за замовчуванням 8000)"
LangString mhddos_requests ${LANG_UKRAINIAN} "Скільки запитів надсилати за одне з’єднання (за замовчуванням is 2000)"
LangString mhddos_proxy ${LANG_UKRAINIAN} "Щоб указати особисті проксі-сервери, використовуйте опцію proxy"
LangString mhddos_proxies ${LANG_UKRAINIAN} "Якщо список проксі-серверів завеликий, скористайтеся локальним або віддаленим файлом проксі. Кожен проксі має бути в новому рядку"