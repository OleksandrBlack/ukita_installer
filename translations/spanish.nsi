...
;MHDDOSSETTINGS
LangString mhddos_settings ${LANG_SPANISH} "Configuración"
LangString mhddos_text_lng ${LANG_SPANISH} "Cambiar el idioma"
LangString mhddos_lang ${LANG_SPANISH} "es"
LangString mhddos_copies ${LANG_SPANISH} "Ejecutar múltiples copias (automático para el valor máximo, requiere 3+ núcleos de CPU y una red estable)"
LangString mhddos_vpn ${LANG_SPANISH} "Añade tu IP/VPN al ataque (cuando utilices una VPN o un servidor dedicado)"
LangString mhddos_percents ${LANG_SPANISH} "Especificar una posibilidad de usar mi IP cuando vpn=true (por defecto 2%)"
LangString mhddos_threads ${LANG_SPANISH} "Número de hilos por copia (por defecto 8000)"
LangString mhddos_requests ${LANG_SPANISH} "Cuántas peticiones enviar en una sola conexión (por defecto son 2000)"
LangString mhddos_proxy ${LANG_SPANISH} "Para especificar proxy(s) personalizados, utilice la opción proxy"
LangString mhddos_proxies ${LANG_SPANISH} "Si la lista de proxies es demasiado grande, utilice la opción de archivo local o remoto proxies. Cada proxy debe estar en una nueva línea"